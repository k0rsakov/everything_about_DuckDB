...
Поэтому сегодня мы рассмотрим разные "*стороны*" DuckDB: мы окунёмся в возможности DuckDB, поговорим о алгоритмах работы
DuckDB, поговорим о реальных кейсах использования DuckDB и также обсудим тонкости DuckDB.
...
оперативную память. Но в тоже время его можно ограничить, чтобы он всё не "
*съел*" — [Configuration](https://duckdb.org/docs/stable/configuration/overview).
